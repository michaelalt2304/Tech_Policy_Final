    ...
    "Will you be processing data from and/or in any of the these regions?": {
        "European Union" : {
            "Does your data include personal data?": {
                "Yes" : "The following laws and regulations are relevant for your scenario: \n\n GDPR (General Data Protection Regulation): European Union regulation providing strong data protection rights, including consent, access, erasure, and data portability; applies globally if processing EU resident data.",
                "No" : "The tool doesn't have any particular laws or policies to recommend considering for your scenario. However, please consult legal and policy experts to understand the laws and regulations that might impact your project." 
            }
        ...
        "Neither" : "The tool doesn't have any particular laws or policies to recommend considering for your scenario. However, please consult legal and policy experts to understand the laws and regulations that might impact your project." 
    }
}